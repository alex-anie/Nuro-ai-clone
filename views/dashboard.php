<main>
    <nav class="h-15 w-full shadow-xl flex justify-between items-center px-10">
       <div>
           <button>
                <svg class="w-[30px] h-[30px] cursor-pointer text-neutral-600 hover:text-sky-500" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.84182 3.13514C9.04327 3.32401 9.05348 3.64042 8.86462 3.84188L5.43521 7.49991L8.86462 11.1579C9.05348 11.3594 9.04327 11.6758 8.84182 11.8647C8.64036 12.0535 8.32394 12.0433 8.13508 11.8419L4.38508 7.84188C4.20477 7.64955 4.20477 7.35027 4.38508 7.15794L8.13508 3.15794C8.32394 2.95648 8.64036 2.94628 8.84182 3.13514Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
        </button>
       </div>
        ...
        <aside class="">
            <form action="" method="post">
                <div class="md:w-100 lg:w-160 h-full flex gap-1 bg-neutral-100 rounded-xl px-2 py-1 focus-within:outline focus-within:outline-sky-500" style="transition: background 0.2s linear;">
                    ...
                    <input class="w-full outline-0 border-0" placeholder="search..." type="text" name="footer-submit" type="search" id="footer-submit" style="font-family: SuisseIntl; font-weight: 200;">
                    <button class="">

    ...
    <div class="overflow-x-auto shadow-md rounded-lg max-h-60 overflow-y-scroll">
      <table class="min-w-full divide-y divide-neutral-200">
        <thead class="bg-sky-100">
          <tr>
            <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-neutral-700">Names</th>
            <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-neutral-700">Email</th>
            <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-neutral-700">Joined Date</th>
          </tr>
        </thead>

...
<main class="bg-neutral-50 px-10 pt-20 ">
    ...
    <section class="">
        ...
        <div>
            <a href="/dashboard/create-blog" class="flex gap-2 items-center group hover:bg-sky-500 bg-sky-800 text-white w-fit py-2 px-4 rounded-2xl">
                <svg class="size-[20px]" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
                <span  style="font-family: SuisseIntl; font-weight: 200;">Create Blog</span>
            </a>
        </div>
        </article>
        <article class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <aside class="w-60 group transition-transform duration-200 ease">
                <div class="size-60 rounded-3xl mb-2 overflow-hidden">

    ...
    <section>
        <form action="" method="post">
            <aside class="relative w-full flex justify-center items-center">
                ...
                <label class="absolute flex items-center gap-x-2 w-fit cursor-pointer hover:bg-sky-500 bg-sky-800 rounded-xl py-2 px-4" for="upload-image">
                    ...
                    <input class="w-0 invisible" type="file" name="" id="upload-image">
                </label>
            </aside>

            <aside class="w-full flex flex-col gap-y-6">
                <input class="border outline-0 border-neutral-500 h-15 rounded-2xl px-4 text-xl text-neutral-600 focus:border focus:border-sky-500" type="text" name="" id="" placeholder="Blog Title..." style="font-family: SuisseIntl; font-weight: 200;">
                <textarea  class="pt-3 border outline-0 border-neutral-500 rounded-2xl px-4 text-xl text-neutral-600 focus:border focus:border-sky-500" name="" id="" rows="10" cols="33" placeholder="create a blog post..." style="font-family: SuisseIntl; font-weight: 200;"></textarea>
